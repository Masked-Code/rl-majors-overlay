    ...
    socket.on('payload', (payload) => {
        ...
        if (payload.data.event === "ctrl_update") {
            let panelSendData = {
                ...
                bracket1: payload.data.contents.bracket1,
                bracket2: payload.data.contents.bracket2,
                bracket3: payload.data.contents.bracket3,
                ...
                bracketround1: payload.data.contents.bracketround1,
                bracketround2: payload.data.contents.bracketround2,
                bracketround3: payload.data.contents.bracketround3,
