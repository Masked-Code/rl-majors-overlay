    ...
    let data = {
        data: {
            ...
            contents: {
                ...
                division1: document.getElementById("division-name-1").value,
                division2: document.getElementById("division-name-2").value,
                division3: document.getElementById("division-name-3").value,
                ...
                divisionround1: document.getElementById("division-round-1").value,
                divisionround2: document.getElementById("division-round-2").value,
                divisionround3: document.getElementById("division-round-3").value,
